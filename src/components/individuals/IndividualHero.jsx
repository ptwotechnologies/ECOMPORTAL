  ...
  return (
    <div className="min-h-screen flex flex-col items-center">
      ...
      <div className="block md:hidden w-full">
        <section className="bg-[#4e6c50] w-full mx-auto rounded-b-2xl px-6 pt-6 pb-24 text-white shadow-lg">
          {/* Small tagline */}
          ...
          <div className="flex justify-center">
            <button className="bg-white text-[#4e6c50] font-medium w-36 h-10 rounded-md hover:opacity-90 transition mb-6 mt-4">
              Get Listed
            </button>
          </div>
        </section>
      ...
      <div className="hidden md:block w-full">
        {/* Hero Section */}
        <section className="w-full max-w-[90%] mx-auto px-12 py-16">
          <div className="text-center mb-12">
            {/* Gray placeholder box with Get Listed button */}
            <div className="bg-gray-300 h-96 rounded-lg flex items-end justify-center mb-8">
              <button className="bg-[#001032] text-white font-medium px-8 py-3 rounded-md hover:bg-[#001d5b] transition mb-6">
                Get Listed
              </button>
            </div>

            {/* Main heading */}
            <h1 className="text-3xl font-semibold mt-10 text-gray-900 max-w-[80%] mx-auto leading-[40px]">
              Grow Your Business by Partnering with India's Fastest-Growing
              Startup Ecosystem
            </h1>
          </div>
