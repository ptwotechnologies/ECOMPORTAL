export default function Startup1Consult() {
  const items = [
  ...
  return (
    <div className="w-full pt-12">
      {/* Top Section */}
      <section className="bg-[#965820] md:bg-gradient-to-b md:from-[#33425b] md:to-[#345259] text-white py-20">
      ...
      <div className="md:hidden px-8 py-16 flex flex-col gap-6 text-center">
        ...
        <button className="text-white bg-[#b67b4a] px-4 py-4 rounded-md w-1/2 mx-auto">
          Let's get started
        </button>
      </div>
      ...
      <section className="py-10">
        <div className="max-w-[95%] mx-auto px-4 md:px-6">
          <h2 className="text-3xl text-[#965820] leading-[40px] md:text-black font-semibold mb-10">
              ...
              .map((_, i) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-center mt-8">
                    <span className="font-semibold text-[#965820] leading-[40px] md:text-gray-800 text-[15px] border-r pr-10 border-gray-300">
                      Design & Branding
                    </span>
                    <span className="w-10 h-10 flex-shrink-0 rounded-full bg-[#47301c] md:bg-[#001F3F]"></span>
                  </div>
                </div>
              ))}
          </div>
