  ...
  return (
    <div className="min-h-screen flex flex-col items-center">
      ...
      <div className="block md:hidden w-full">
        <section className="bg-gradient-to-b from-[#6B4226] to-[#6B4226] w-full mx-auto rounded-2xl px-6 pt-12 pb-24 text-white shadow-lg">
          {/* Small tagline */}
          ...
          <div className="flex justify-center">
            <button className="bg-white text-[#6B4226] font-medium w-36 h-10 rounded-md hover:opacity-90 transition mb-6 mt-4">
              Get Listed
            </button>
          </div>
        </section>
        ...
        <section className="py-8 mt-6">
          <div className="px-6 grid grid-cols-2 gap-8 text-white">
            <div className="rounded-xl h-40 px-4 py-3 bg-white">
            </div>
            <div className="rounded-xl h-40 px-4 py-3 bg-white">
            </div>
            <div className="rounded-xl h-40 px-4 py-3 bg-white">
