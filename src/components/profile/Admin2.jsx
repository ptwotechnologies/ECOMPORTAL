        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {users.map((user, index) => (
            <div className="flex flex-col">
              ...
              <div className="flex justify-between gap-4 px-6 my-2 mt-3 w-full">
                <button className="px-4 w-1/2 py-2 rounded-lg text-white text-[18px] font-medium bg-[#335559]">
                  Approve
                </button>
                <button className="px-4 w-1/2 py-2 rounded-lg text-white text-[18px] font-medium bg-[#ba1e1e]">
                  Reject
                </button>
              </div>
            </div>
