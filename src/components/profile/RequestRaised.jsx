        ...
        <div className="flex gap-4 items-stretch">
          ...
          <div className="flex flex-col justify-between w-full md:w-[60%] items-center h-full">
            <div className="border px-6 py-3 flex flex-col gap-6 bg-white border-gray-300 shadow-md rounded-lg w-full h-full">
              ...
              {/* Grid Section (responsive behavior applied) */}
              <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-5 py-4 mb-16">
                {visibleOptions.map((option) => (
                  ...
                  >
                    <div className="flex-shrink-0 p-3 border-2 border-gray-200 rounded-full transition-colors">
                      <div
                        className="w-5 h-5 rounded-full border-2 flex items-center justify-center border-gray-900"
                      >
