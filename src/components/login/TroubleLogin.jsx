...
function TroubleLogin() {
  ...
  return (
    <>
      <div className="min-h-screen md:mt-12 flex items-center justify-center p-0 md:p-8">
        <div className="w-full md:w-[90%] flex items-center">
          {/* Left Side - centered */}
          <div className="hidden md:flex flex-col items-center mb-[260px] w-1/3">
            <div>
              <img
                src={Logo}
                alt="Artestor Logo"
          ...
          <div className="w-full md:w-2/3 justify-center flex">
            <div className="w-full md:w-2/3 flex flex-col justify-center items-center md:rounded-[20px] shadow-xl border-[19px] border-[#6B4226] p-8 md:p-12">
              {/* Logo */}
              <img
                src={Logo}
                alt="Logo"
              ...
              {/* Subtitle */}
              <p className="text-center text-[16px] font-medium text-[#6B4226] my-2">
                Trouble logging in?
              </p>
              <p className="text-center text-[16px] font-medium text-[#6B4226] mb-8 mt-2 md:px-10 leading-relaxed">
              ...
              <div className="space-y-6 w-full">
                <input
                  ...
                  className="w-full px-4 py-3 border border-[#E5E7EB] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6B4423] text-[14px] text-[#111827] placeholder:text-[#9CA3AF] mb-60"
                />
