...
const ChannelNavbar = () => {
  ...
  return (
    <nav className="px-4 py-3 flex items-center bg-[#011032] rounded-t-lg md:bg-white justify-between relative">
      {/* Left: Logo */}
      ...
      {menuOpen && (
        <div className="absolute top-full left-0 w-full bg-white flex flex-col items-center space-y-4 py-6 md:hidden shadow-lg z-50 rounded-2xl">
          <a
            href="#"
            className="bg-[#011032] text-white flex items-center gap-1 justify-center px-4 py-2 rounded-full text-sm"
          >
            Auxiliaries <MdOutlineKeyboardArrowDown />
          </a>
          <a
            href="#"
            className="hover:bg-[#011032] px-4 py-2 rounded-full font-medium text-sm"
          >
            Pricing
          </a>
          <a
          ...
          <a
            href="#"
            className="underline underline-offset-4 hover:bg-[#011032] px-4 py-2 rounded-full text-sm"
          >
            Sign in
          </a>
          <a
            href="#"
            className="bg-[#011032] px-6 py-2 rounded text-sm"
          >
            Sign up
          </a>
        </div>
