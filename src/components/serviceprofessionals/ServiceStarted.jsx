  ...
  return (
    <div>
      ...
      <section className="block md:hidden">
        <hr className="m-8 border-gray-600/80" />
        <div className=" md:hidden min-h-screen flex flex-col items-center">
          ...
          <div className="w-full text-center py-10">
            ...
            <button className="bg-[#0D1B2A] border border-white text-white px-6 py-3 rounded-lg font-medium hover:bg-[#142f49] leading-relaxed">
              Click here & Get started
            </button>
          </div>

          {/* Info Card Section */}
          <div className="max-w-sm w-full bg-white shadow-md rounded-2xl px-6 py-4 pt-12 my-6">
