...
export default function PricingFaq() {
  ...
  return (
    <div className="bg-[#fdf5ea] min-h-screen p-10">
      {/* Section Heading */}
            ...
            <div className="p-6">
              ...
              <div className="space-y-2 mb-6">
                <p className="flex items-center gap-4 text-[14px] leading-[40px]">
                  <FaCheck className="text-[#87644c]" /> Fund admin
                </p>
                <p className="flex items-center gap-4 text-[14px] leading-[40px]">
                  <FaCheck className="text-[#87644c]" /> Legal fund formation
                </p>
              </div>
              <div className="flex flex-col gap-16 text-sm text-gray-500">
                <p>* Pricing may vary with add-on services</p>
                <button className="w-full bg-[#6b4b3e] text-white py-4 text-lg rounded-md font-medium hover:bg-[#5a3f33] transition">
                  Get started
                </button>
              </div>
            </div>
