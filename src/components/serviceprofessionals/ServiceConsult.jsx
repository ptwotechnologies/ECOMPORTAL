export default function ServiceConsult() {
  const items = [
  ...
  const mobileItems = [
    {
      name: "Get clients without paid marketing :",
      text: " Work with pre-vetted startups actively seeking expert services without any ads or paid marketing.",
    },
    {
      name: "All payments are protected :",
      text: " All transactions are overseen by our admin team for clarity and accountability. Work with pre-vetted startups actively seeking expert services without any ads or paid marketing.",
    },
    {
      name: "Guidance when you need it :",
      text: " Get one-on-one guidance with portfolio, pricing, pitch decks and positioning ",
    },
    {
      name: "Access to active investors :",
      text: " Build credibility and visibility within our growing investor network",
    },
    {
      name: "Seamless project coordination :",
      text: " We manage introductions, clarify project scopes, and keep things moving smoothly.",
    },
    {
      name: "Verified clients with zero scam risk :",
      text: " We maintain a 99.99% scam-free ecosystem, so you don’t waste time on fake leads or risky deals.",
    },
    {
      name: "Opportunity to become a channel partner :",
      text: " Join as a core collaborator and expand your service visibility",
    },
  ];
  ...
  return (
    <div className="w-full pt-12">
      {/* Top Section */}
      <section className="bg-[#87664c] md:bg-[#d1875f] text-white py-10 md:py-24">
        <div className="max-w-[98%] mx-auto px-4 md:px-10">
          ...
          <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-24 px-6">
          ...
          <div className="md:hidden grid grid-cols-1 md:grid-cols-3 gap-12 px-6">
            {mobileItems.map((item, index) => (
              <div
                key={index}
                className="flex flex-col border-l opacity-80 border-gray-300 pl-4 justify-center"
              >
                <h3 className="text-3xl font-medium leading-relaxed px-2 pb-2">{index + 1}</h3>
                <p className="text-[14px] mb-1 leading-relaxed">{item.name}</p>
